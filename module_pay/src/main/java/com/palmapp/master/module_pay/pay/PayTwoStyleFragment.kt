...
import kotlinx.android.synthetic.main.pay_fragment_two.iv_payment_close
import kotlinx.android.synthetic.main.pay_fragment_two.tv_payment_btn_subtext1
import kotlinx.android.synthetic.main.pay_fragment_two.tv_payment_btn_subtext2
import kotlinx.android.synthetic.main.pay_fragment_two.tv_payment_btn_text1
import kotlinx.android.synthetic.main.pay_fragment_two.tv_payment_btn_text2
import kotlinx.android.synthetic.main.pay_fragment_two.*
import kotlinx.android.synthetic.main.pay_fragment_two.view_payment_btn1
import kotlinx.android.synthetic.main.pay_fragment_two.view_payment_btn2
 ...
 * @since :      2019/8/21
 */
class PayTwoStyleFragment : PayBaseStyleFragment() {
    ...
    override fun getResLayout() = R.layout.pay_fragment_two

    override fun getDefaultConfig(): PaymentGuideConfig? {
        style = if (isLauncherScen()) "local_style2" else "internal_style2"
    ...
    inner class MyAdapter : PagerAdapter() {
        ...
        override fun instantiateItem(container: ViewGroup, position: Int): Any {
            val view = LayoutInflater.from(activity)
                .inflate(R.layout.pay_layout_two_video, container, false)
        ...
        paymentGuideConfig?.let { paymentGuideConfig ->
            ...
            activity?.let { activity ->
                ...
                view_payment_btn2.setOnClickListener {
                    ...
                    tv_payment_tab.visibility = View.VISIBLE
                    tv_payment_btn_subtext1.visibility = View.GONE
                    if (!TextUtils.isEmpty(paymentGuideConfig.option2Text2)) {
