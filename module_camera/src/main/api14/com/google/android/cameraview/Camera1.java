...
//            float r = ratio.getY() / (float) ratio.getX();
//            float temp = Math.abs(rs - r);
//            if (temp < min) {
//                min = temp;
//                mAspectRatio = ratio;
//            }
...
//        final Size pictureSize = mPictureSizes.sizes(mAspectRatio).last();
        ...
        Camera.Size previewSize = getOptimalSize(mCameraParameters.getSupportedPreviewSizes(), mPreview.getWidth(), mPreview.getHeight());
        Camera.Size pictureSize = getOptimalSize(mCameraParameters.getSupportedPictureSizes(), mPreview.getWidth(), mPreview.getHeight());
    ...
    private Camera.Size getOptimalSize(List<Camera.Size> sizes, int w, int h) {
        Camera.Size optimalSize = sizes.isEmpty() ? null : sizes.get(0);
