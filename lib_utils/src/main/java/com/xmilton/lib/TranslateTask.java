...
public class TranslateTask {
    //多语言表
    private static final String IN_PATH = "D:\\Android\\Workspace\\palm_truck\\lib_utils\\src\\main\\java\\com\\xmilton\\lib\\49122.xlsx";
    //项目地址
    ...
    static {
        ...
        mMap.put("意大利语（IT）", "values-it");
        mMap.put("孟加拉语", "values-bn");
        mMap.put("波斯语", "values-fa");
        mMap.put("越南语", "values-vi");
        mMap.put("泰语", "values-th");
        mMap.put("土耳其语", "values-tr");
        mMap.put("阿拉伯语", "values-ar");
    }
    ...
    public void readExcel() {
        try {
            ...
            for (int i = sheet.getFirstRowNum(), rowCount = 0; rowCount < sheet.getLastRowNum(); i++) {
                row = sheet.getRow(i);
                if (row == null)
                    break;
    ...
    private String getRealLanuages(String lanuage) {
        ...
        System.out.println("未找到语言：" + lanuage);
        return null;
    }
